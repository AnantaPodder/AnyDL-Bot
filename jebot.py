...
@Jebot.on_message(filters.text & ~filters.edited & filters.regex(YTDL_REGEX))
async def ytdl_with_button(_, message: Message):
    try:
        ...
        with YoutubeDL(ydl_opts) as ydl:
            ...
            # download
            # await message.edit_message_text("**Downloading audio...**")
...
async def send_audio(message: Message, info_dict, audio_file):
    ...
    title = "Enjoy - " + s2tw(info_dict["title"])
